...
function generateRaidEnemy() {
    ...
    let scale = Math.pow(1.15, heroLevel - 1);

    if (heroLevel >= 15) {
       scale *= Math.pow(1.2, heroLevel - 14);
    }
...
if (typeof upgradeCastle !== "undefined") window.upgradeCastle = upgradeCastle;
if (typeof upgradeBuilding !== "undefined") window.upgradeBuilding = upgradeBuilding;
if (typeof fight !== "undefined") window.fight = fight;
if (typeof train !== "undefined") window.train = train;
if (typeof equip !== "undefined") window.equip = equip;
if (typeof equipAll !== "undefined") window.equipAll = equipAll;
if (typeof hireArmy !== "undefined") window.hireArmy = hireArmy;
if (typeof startRaid !== "undefined") window.startRaid = startRaid;
if (typeof buyShopItem !== "undefined") window.buyShopItem = buyShopItem;
if (typeof addFriend !== "undefined") window.addFriend = addFriend;
